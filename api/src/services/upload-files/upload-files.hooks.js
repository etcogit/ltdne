...
module.exports = {
  before: {
    ...
    create: [
      function(context) {
        // console.log(context)
        console.log('upload-files BEFORE ')
  ...
  after: {
    ...
    create: [
      function(context) {
        console.log('upload-files AFTER :')
        // console.log(context)
        ...
        delete context.data.uri // je supprime de 'result' (donc de la réponse envoyée au client) le binaire du fichier pcq ce n'est pas nécessaire de le renvoyer au client
        console.log(context)
        ...
        return context.app.service('/uploads').create({
          ...
          emailUploader: context.data.emailUploader,
          nom: context.data.nom,
          prenom: context.data.prenom,
          emailOwner: context.data.emailOwner,
          tel: context.data.tel,
          agreedTerms: context.data.agreedTerms,
